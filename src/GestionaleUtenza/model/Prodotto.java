...
public class Prodotto {
    ...
    public Integer getFkCategoria() {return fkCategoria;}
    public boolean isAttivo() {return attivo;}
    public Categoria getCategoria() {return categoria;}

    public void setIdProdotto(int v) {this.idProdotto=v;}
    public void setNome(String v) {this.nome=v;}
    public void setDescrizione(String v) {this.descrizione=v;}
    public void setPrezzoBase(double v) {this.prezzoBase=v;}
    public void setStock(int v) {this.stock=v;}
    public void setFkCategoria(Integer v) {this.fkCategoria=v;}
    ...
    public String toString() {
        ...
        return String.format("[%d] %-30s €%6.2f  stock:%-4d  cat:%s", idProdotto, nome, prezzoBase, stock, cat);
    }
}